# Operator Quickstart — Community Learning Support

Shortest path from clone to a verified local dry-run for **ISIC 8569** (`cloud-itonami-isic-8569`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8569.git
cd cloud-itonami-isic-8569
```
...
- Blueprint governor key: `learner-safety-governor`
- Likely source path: `learning.governor.cljc`
